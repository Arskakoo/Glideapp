 ...
 */ (function (e) {
  ...
  function r(b) {
    ...
    if (j !== N) {
      b[0] = j;
      e: for (var I = 0, A = b.length, G = A >>> 1; I < G; ) {
        var re = 2 * (I + 1) - 1,
          ve = b[re],
          K = re + 1,
          z = b[K];
        if (0 > o(ve, j))
          K < A && 0 > o(z, ve)
            ? ((b[I] = z), (b[K] = j), (I = K))
            : ((b[I] = ve), (b[re] = j), (I = re));
        else if (K < A && 0 > o(z, j)) (b[I] = z), (b[K] = j), (I = K);
        else break e;
      }
    }
    return N;
  ...
  function E(b, N) {
    ...
    try {
      for (
        v(N), p = n(a);
        p !== null && (!(p.expirationTime > N) || (b && !D()));

      ) {
        var I = p.callback;
        if (typeof I == "function") {
          (p.callback = null), (c = p.priorityLevel);
          var A = I(p.expirationTime <= N);
          (N = e.unstable_now()),
    ...
    (e.unstable_scheduleCallback = function (b, N, j) {
      ...
      return (
        ...
        j > I
          ...
          : ((b.sortIndex = A), t(a, b), w || y || ((w = !0), V(E))),
        b
      );
    }),
...
function rh(e) {
  if (Ct && typeof Ct.onCommitFiberRoot == "function")
    try {
      Ct.onCommitFiberRoot(Hl, e, void 0, (e.current.flags & 128) === 128);
    } catch {}
}
...
function nl(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = ko(n)), t !== null && sa(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
var kr = {
  ...
  Si = et(yh),
  wh = me({}, kr, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  xh = et(wh),
  Sh = me({}, kr, {
...
var _h = me({}, Eo, {
  ...
  Oh = et(Rh),
  Lh = me({}, kr, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Mh = et(Lh),
  Ih = me({}, Ul, {
    deltaX: function (e) {
...
function jh(e, t) {
  switch (e) {
    case "compositionend":
      return Bd(t);
    case "keypress":
      return t.which !== 32 ? null : (($u = !0), Cu);
    case "textInput":
      return (e = t.data), e === Cu && $u ? null : e;
    default:
      return null;
  }
}
...
function Ql(e) {
  ...
  var t = Gn[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in Qd) return (Ci[e] = t[n]);
  return e;
}
...
var Cr = Math.random().toString(36).slice(2),
  ...
  ws = "__reactEvents$" + Cr,
  l0 = "__reactListeners$" + Cr,
  i0 = "__reactHandles$" + Cr;
function En(e) {
  var t = e[St];
  if (t) return t;
...
function df(e) {
  ...
  function w(f, d, v, x) {
    for (
      var E = null, $ = null, k = d, C = (d = 0), M = null;
      k !== null && C < v.length;
      C++
    ) {
    ...
    for (k = r(f, k); C < v.length; C++)
      (M = y(k, f, C, v[C], x)),
        M !== null &&
          (e && M.alternate !== null && k.delete(M.key === null ? C : M.key),
          (d = l(M, d, C)),
          $ === null ? (E = M) : ($.sibling = M),
          ($ = M));
    return (
  ...
  function g(f, d, v, x) {
    ...
    for (
      var $ = (E = null), k = d, C = (d = 0), M = null, O = v.next();
      k !== null && !O.done;
      C++, O = v.next()
    ) {
      k.index > C ? ((M = k), (k = null)) : (M = k.sibling);
      var D = c(f, k, O.value, x);
      if (D === null) {
        k === null && (k = M);
        break;
      }
    ...
    if (O.done) return n(f, k), de && xn(f, C), E;
    if (k === null) {
      for (; !O.done; C++, O = v.next())
        (O = p(f, O.value, x)),
          O !== null &&
            ((d = l(O, d, C)), $ === null ? (E = O) : ($.sibling = O), ($ = O));
      return de && xn(f, C), E;
    }
    for (k = r(f, k); !O.done; C++, O = v.next())
      (O = y(k, f, C, O.value, x)),
        O !== null &&
          (e && O.alternate !== null && k.delete(O.key === null ? C : O.key),
          (d = l(O, d, C)),
          $ === null ? (E = O) : ($.sibling = O),
          ($ = O));
    return (
...
var hr = df(!0),
  ...
  po = gn(Co);
function Cn(e) {
  if (e === Co) throw Error(P(174));
  return e;
}
function Ea(e, t) {
  switch ((le(po, t), le(fo, e), le($t, Co), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function $f(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), Zl(4, 4, Cf.bind(null, t, e), n)
  );
}
function Na() {}
function bf(e, t) {
  ...
  p0 = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        sl(4194308, 4, Cf.bind(null, t, e), n)
      );
    },
  ...
  if ((ar(t, o), t.stateNode === null))
    ...
    (i.state = c),
      ...
      s !== r || c !== a || Ve.current || Jt
        ? (typeof m == "function" && (Cs(t, n, m, r), (a = t.memoizedState)),
  ...
  switch ((ha(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) Wf(e, t, e.memoizedProps, r);
        ...
        if (((n = Cn(po.current)), Cn($t.current), jo(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[St] = t),
...
function k0(e, t) {
  ...
  for (vs = { focusedElem: e, selectionRange: n }, xl = !1, L = t; L !== null; )
...
function Yf(e, t, n) {
  for (var r = (e.mode & 1) !== 0; L !== null; ) {
    ...
    if (o.tag === 22 && r) {
      ...
      o.subtreeFlags & 8772 && l !== null ? ((l.return = o), (L = l)) : ic(e);
  }
}
function ic(e) {
  for (; L !== null; ) {
...
function Gf(e, t) {
  ...
  if (r & 30 || r & e.expiredLanes || t) t = zl(e, r);
    ...
    X |= 2;
    var l = Zf();
    (ke !== e || $e !== t) && ((Nt = null), (yr = ge() + 500), bn(e, t));
    do
      try {
        _0();
        break;
...
function Aa() {
  (xe === 0 || xe === 3 || xe === 2) && (xe = 4),
    ke === null || (!(Rn & 268435455) && !(ql & 268435455)) || en(ke, $e);
}
function zl(e, t) {
  var n = X;
  X |= 2;
  var r = Zf();
  (ke !== e || $e !== t) && ((Nt = null), bn(e, t));
  do
    try {
      P0();
      break;
  ...
  if (nn !== null) {
    ...
    try {
      if (((lt.transition = null), (ne = 16 > e ? 16 : e), nn === null))
        ...
        if (
          ((X = o), yn(), Ct && typeof Ct.onPostCommitFiberRoot == "function")
        )
          try {
            Ct.onPostCommitFiberRoot(Hl, e);
          } catch {}
        r = !0;
      }
      return r;
...
Sd = Ma;
Ed = On;
var j0 = { usingClientEntryPoint: !1, Events: [ko, Xn, Yl, wd, xd, Ma] },
  Dr = {
...
const ev = h.createContext({
  ...
  tv = h.forwardRef((e, t) => {
    ...
    const {
      ...
      $ = nv((C) => {
        const M = C.target,
          O = [...m.branches].some((D) => D.contains(M));
        !E ||
          O ||
          (l == null || l(C),
          s == null || s(C),
      ...
      k = rv((C) => {
        const M = C.target;
        [...m.branches].some((D) => D.contains(M)) ||
          (i == null || i(C),
          s == null || s(C),
          C.defaultPrevented || a == null || a());
      }, y);
    ...
    async fn(t) {
      ...
      const C = x / 2 - E / 2,
        ...
        V =
          ...
          br(o) != null &&
          W !== B &&
          l.reference[w] / 2 - (W < T ? O : D) - g[w] / 2 < 0,
        F = V ? (W < T ? W - T : W - Y) : 0;
      return {
        [y]: c[y] + F,
        data: {
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          if (
            ...
            var M, O;
            const T = (((M = l.flip) == null ? void 0 : M.index) || 0) + 1,
              Y = E[T];
            if (Y)
              return {
            ...
            let W =
              (O = C.filter((B) => B.overflows[0] <= 0).sort(
        ...
        switch (r) {
          case "referenceHidden": {
            const l = await yo(t, { ...o, elementContext: "reference" }),
              i = kc(l, n.reference);
            return {
              data: { referenceHiddenOffsets: i, referenceHidden: Cc(i) },
            };
          }
          case "escaped": {
            const l = await yo(t, { ...o, altBoundary: !0 }),
              i = kc(l, n.floating);
            return { data: { escapedOffsets: i, escaped: Cc(i) } };
          }
          default:
            return {};
        }
        ...
        async fn(t) {
          ...
          if (
            ...
            const C = Ye(a.left, 0),
              ...
              D = Ye(a.bottom, 0);
            p
              ? ($ = c - 2 * (C !== 0 || M !== 0 ? C + M : Ye(a.left, a.right)))
              : (E =
                  y - 2 * (O !== 0 || D !== 0 ? O + D : Ye(a.top, a.bottom)));
          }
  ...
  const i = [
    ...
    a = i.reduce((u, m) => {
      ...
      return (
        ...
        (u.right = kt(p.right, u.right)),
        (u.bottom = kt(p.bottom, u.bottom)),
  ...
  fl(
    ...
    fl(() => {
      if ((x && ($.current = x), E && (k.current = E), x && E)) {
        if (O.current) return O.current(x, E, T);
        T();
      }
    }, [x, E, T, O, M]);
  const W = h.useMemo(
...
const py = [" ", "Enter", "ArrowUp", "ArrowDown"],
  ...
  wy = (e) => {
    const {
      ...
      [C, M] = Rc({ prop: i, defaultProp: s, onChange: a }),
      O = h.useRef(null),
  ...
  $y = (e) => h.createElement(Cg, te({ asChild: !0 }, e)),
  Sr = "SelectContent",
  by = h.forwardRef((e, t) => {
  ...
  Py = h.forwardRef((e, t) => {
    ...
    const [j, I] = Bp((z) => {
      ...
      re = h.useCallback(
        (z, J, ce) => {
          const q = !B.current && !ce;
          ((d.value !== void 0 && d.value === J) || q) && D(z);
        },
        [d.value]
      ),
      ve = r === "popper" ? zc : _y,
                ...
                K,
                {
                  ...
                  onKeyDown: Ee(f.onKeyDown, (z) => {
                    ...
                    if (
                      ...
                      setTimeout(() => V(q)), z.preventDefault();
                    }
                  }),
                }
              )
      ...
      v = h.useCallback(() => {
        if (l.trigger && l.valueNode && s && u && g && S && f) {
          const k = l.trigger.getBoundingClientRect(),
            ...
            M = l.valueNode.getBoundingClientRect(),
            O = f.getBoundingClientRect();
          if (l.dir !== "rtl") {
            const ee = O.left - C.left,
              Z = M.left - ee,
              Me = k.left - Z,
              _e = k.width + Me,
            ...
            const ee = C.right - O.right,
              Z = window.innerWidth - M.right - ee,
          ...
          const D = c(),
            ...
            ce = N - J;
          if (J <= re) {
            const ee = S === D[D.length - 1].ref.current;
            s.style.bottom = "0px";
            ...
            const ee = S === D[0].ref.current;
            s.style.top = "0px";
            const Me = Math.max(re, B + g.offsetTop + (ee ? A : 0) + K) + ce;
...
const k1 = new Set(["length", "size", "percentage"]);
function C1(e) {
  return Tr(e, k1, nm);
}
function $1(e) {
...
function O1() {
  ...
  return {
    ...
    classGroups: {
      ...
      "bg-size": [{ bg: ["auto", "cover", "contain", C1] }],
      "bg-image": [
        {
          bg: [
            "none",
  ...
  rm = h.forwardRef(({ className: e, children: t, ...n }, r) =>
    R.jsxs(Wp, {
      ...
      children: [
        ...
        R.jsx(Ky, {
          asChild: !0,
          children: R.jsx(Xp, { className: "h-4 w-4 opacity-50" }),
        }),
      ],
    })
  );
...
const om = h.forwardRef(({ className: e, ...t }, n) =>
  R.jsx(Qp, {
    ...
    ...t,
    children: R.jsx(e1, { className: "h-4 w-4" }),
  })
);
...
const lm = h.forwardRef(({ className: e, ...t }, n) =>
  R.jsx(Yp, {
    ...
    className: Vt("flex cursor-default items-center justify-center py-1", e),
    ...t,
    children: R.jsx(Xp, { className: "h-4 w-4" }),
  })
);
  ...
  R.jsxs(Kp, {
    ...
    children: [
      R.jsx("span", {
        ...
        children: R.jsx(Xy, { children: R.jsx(qy, { className: "h-4 w-4" }) }),
      }),
      R.jsx(Gy, { children: t }),
    ],
  })
...
const B1 = ({ onStart: e }) => {
    ...
    return r
      ...
      : l
      ? R.jsxs("div", { children: ["Error: ", l] })
      : R.jsxs("div", {
          className: "flex h-screen items-center justify-center flex-col",
          children: [
            R.jsx("div", {
              className: "font-bold text-6xl text-green-700 tracking-wide",
              children: R.jsxs("p", {
                className: "flex items-center gap-2",
                children: [
                  "Glide",
                  R.jsx("img", { src: "./kori.svg", className: "w-7" }),
                ],
              }),
            }),
            R.jsxs("div", {
              ...
              children: [
                R.jsxs(M1, {
                  ...
                  children: [
                    R.jsx(rm, {
                      className: "w-[300px]",
                      children: R.jsx(I1, { placeholder: "Valitse rata" }),
                    }),
                    R.jsx(im, {
                      children: t.map((p) =>
                        R.jsx(sm, { value: p.id, children: p.name }, p.id)
                      ),
                    }),
                  ],
                }),
...
var mw = (e) => {
  let {
    ...
    j = _.useCallback(
      (I) => {
        var A;
        ((A = E.find((G) => G.id === I.id)) != null && A.delete) ||
          Ke.dismiss(I.id),
  ...
  return (
    _.useEffect(
      () =>
        Ke.subscribe((I) => {
          if (I.dismiss) {
            $((A) => A.map((G) => (G.id === I.id ? { ...G, delete: !0 } : G)));
            return;
          }
          setTimeout(() => {
            sp.flushSync(() => {
              $((A) => {
                let G = A.findIndex((re) => re.id === I.id);
                return G !== -1
                  ? [...A.slice(0, G), { ...A[G], ...I }, ...A.slice(G + 1)]
                  : [I, ...A];
              });
            });
          });
    ...
    _.useEffect(() => {
      let I = (A) => {
        var G, re;
        r.every((ve) => A[ve] || A.code === ve) &&
          (D(!0), (G = V.current) == null || G.focus()),
          A.code === "Escape" &&
      ...
      ? _.createElement(
          ...
          k.map((I, A) => {
            ...
            return _.createElement(
              ...
              E.filter((K) => (!K.position && A === 0) || K.position === I).map(
                (K, z) => {
                  var J, ce;
...
const qo = {
  ...
  hw = ({ courseId: e, onBack: t }) => {
    ...
    h.useEffect(() => {
      (async () => {
        try {
          l(!0);
          const $ = W1.courses.find((k) => k.id === e);
          $
            ? (p(0), y(0), u(1), r($), g([]))
            : s(`Course with id ${e} not found.`);
        } catch (E) {
          s(E.message), console.error("Error fetching course data:", E);
        } finally {
          l(!1);
        }
      })();
    ...
    const S = () => {
      ...
      f = () => {
        ...
        E > 0
          ...
          : E < 0 &&
            ($ =
              Object.keys(qo.down_par).find((M) => qo.down_par[M] === `${E}`) ||
              `${E}`),
          g([...w, { hole: a, throws: m, result: $ }]);
        const k = m,
          C = JSON.parse(localStorage.getItem("roundsData")) || {};
        (C[e] = C[e] || []),
          C[e].push(k),
          localStorage.setItem("roundsData", JSON.stringify(C)),
          p(0),
          y(c + 1),
          rw(`Väylä ${a}: ${m} heittoa (${$})`),
          a < Object.keys(n.holes).length && u(a + 1);
      },
      d = () => {
        t();
      };
    if (o) return R.jsx("div", { children: "Loading course data..." });
    if (i) return R.jsxs("div", { children: ["Error: ", i] });
    if (!n) return R.jsx("div", { children: "No course data available." });
    const v = a === Object.keys(n.holes).length;
    return R.jsxs("div", {
      className: "m-6",
      children: [
        R.jsx(mw, { position: "top-center" }),
        R.jsxs("div", {
          className: "text-center font-bold text-2xl flex",
          children: [
            R.jsx("p", { className: "", children: n.name }),
            R.jsx(rr, {
              onClick: d,
              className: "ml-auto",
              variant: "ghost",
            ...
            children: R.jsxs("li", {
              children: [
                R.jsxs("p", {
                  ...
                  children: ["Väylä ", R.jsx("span", { children: a })],
                }),
                R.jsxs("p", {
                  children: [
                    "Par: ",
                    R.jsx("span", { children: n.holes[a].par }),
                  ],
                }),
                R.jsxs("p", {
                  children: [
                    "Matka: ",
                    R.jsxs("span", { children: [n.holes[a].length, "m"] }),
                  ],
                }),
              ],
            }),
        ...
        R.jsxs("div", {
          className: "my-5 opacity-30 text-green-700 text-center m-auto w-fit",
          children: [
            R.jsx("p", {
              className: "text-9xl border-b-2 mb-2 border-green-700",
              children: m,
            }),
            R.jsx("p", {
        ...
        R.jsx("div", {
          ...
          children: v
            ? R.jsx(rr, {
                onClick: d,
                className:
                  "bg-green-700 mr-10 w-1/3 ml-auto text-white font-semibold",
                variant: "secondary",
                children: "Takaisin",
              })
            : R.jsxs("div", {
  ...
  vw = () => {
    ...
    return R.jsx("div", {
      children: e
        ? R.jsx(hw, { courseId: e, onBack: r })
        : R.jsx(B1, { onStart: n }),
    });
  };
Qi.createRoot(document.getElementById("root")).render(
  R.jsx(_.StrictMode, { children: R.jsx(vw, {}) })
);
